...
try:
    ...
    from torchvision.models.mnasnet import _MODEL_URLS as mnasnet_model_urls
    ...
    from torchvision.models.quantization.inception import quant_model_urls as inception_model_urls
    ...
    from torchvision.models.quantization.shufflenetv2 import quant_model_urls as shufflenetv2_model_urls
